...
st.markdown("Upload legal documents (PDF, DOCX, or TXT), and receive a concise summary or find answers to specific questions.")
...
if uploaded_files:
    ...
    for file in uploaded_files:
        ...
        action = st.radio(f"What would you like to do with **{file.name}**?", ["Summarize", "Find Something"], key=file.name)
